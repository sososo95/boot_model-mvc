...
<script type="text/javascript">
	...
	$(function() {
		...
		$("td.ct_btn01:contains('수정')").on("click", function() {
			self.location = "/purchase/updatePurchase?prodNo=${pur.purchaseProd.prodNo}";
		})
		
		$("td.ct_btn01:contains('확인')").on("click", function() {
			self.location = "/purchase/listPurchase?page=1";
		})
...
<%-- 		<c:if test = "${ fn:trim(pur.paymentOption) eq null}" >
			...
		</c:if> --%>
		<c:if test = "${ fn:trim(pur.paymentOption) eq '1'}" >
			현금구매
		</c:if>
		<c:if test = "${ fn:trim(pur.paymentOption) eq '2'}" >
			신용구매
		</c:if>
			...
			<table border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td background="/images/ct_btnbg02.gif" class="ct_btn01"	style="padding-top: 3px;">
						<!--  <a href="/purchase/updatePurchase?prodNo=${pur.purchaseProd.prodNo}">수정</a> -->
						수정
					</td>
					...
					<td background="/images/ct_btnbg02.gif" class="ct_btn01"	style="padding-top: 3px;">
						<!--  <a href="/purchase/listPurchase?page=1">확인</a> -->
						확인
					</td>
					<td width="14" height="23">
						<img src="/images/ct_btnbg03.gif"width="14" height="23"/>
